/**
* The program crashed when the input was not 1,2,3,4 or 5. Instead using a try and catch, the program does not crash.
*/
...
catch (InputMismatchException e) {System.out.println("Enter an integer 1 to 5");
